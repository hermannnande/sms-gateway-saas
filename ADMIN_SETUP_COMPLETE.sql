-- =============================================
-- SCRIPT COMPLET: Créer tables Admin + Ajouter premier admin
...
-- =============================================
-- AJOUTER LE PREMIER ADMIN: hermannnande@gmail.com
-- =============================================
...
BEGIN
  ...
  ELSE
    RAISE WARNING '⚠️ Utilisateur hermannnande@gmail.com non trouvé. Inscrivez-vous d''abord sur le site.';
  END IF;
END $$;
