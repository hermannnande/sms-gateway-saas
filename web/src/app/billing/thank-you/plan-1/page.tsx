...
export default function ThankYouPlan1() {
  const planDetails = {
    name: 'Plan Monthly - 1 appareil',
    price: '9,900 F CFA',
    features: [
      'SMS illimités',
      '1 appareil Android',
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-green-600 mb-2">Paiement reçu ! 🎉</h1>
        ...
        {/* Card */}
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-8 border-2 border-green-500/20">
          {/* Plan Details */}
          <div className="mb-8 pb-8 border-b border-gray-200 dark:border-gray-700">
            <h2 className="text-2xl font-bold mb-2">{planDetails.name}</h2>
            <p className="text-3xl font-bold text-green-600">{planDetails.price}</p>
