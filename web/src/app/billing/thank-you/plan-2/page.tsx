...
export const metadata: Metadata = {
  title: 'Merci pour votre paiement - Plan 2 appareils | SMS Gateway',
  description: 'Votre paiement a été reçu. Nous allons activer votre abonnement sous peu.',
}

export default function ThankYouPlan2() {
  const planDetails = {
    name: 'Plan Monthly - 2 appareils',
    price: '15,900 F CFA',
    paymentLink: 'https://coachingexpert.mychariow.shop/prd_iz04di/checkout',
    features: [
      'SMS illimités',
      '2 appareils Android',
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/20 dark:to-cyan-950/20 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-24 h-24 bg-blue-500 rounded-full mb-6 animate-bounce">
            <svg className="w-12 h-12 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
            </svg>
          </div>
          <h1 className="text-4xl font-bold text-blue-600 mb-2">Paiement reçu ! 🎉</h1>
        ...
        {/* Card */}
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-8 border-2 border-blue-500/20">
          {/* Plan Details */}
          <div className="mb-8 pb-8 border-b border-gray-200 dark:border-gray-700">
            <h2 className="text-2xl font-bold mb-2">{planDetails.name}</h2>
            <p className="text-3xl font-bold text-blue-600">{planDetails.price}</p>
          ...
          <a
            href={`https://wa.me/2250778030075?text=${encodeURIComponent(
              `Bonjour ! 🎉\n\nJe viens de payer pour le *${planDetails.name}* (${planDetails.price}) via Chariow.\n\nMon email d'inscription : [VOTRE_EMAIL]\n\nMerci d'activer mon abonnement.`
            )}`}
            target="_blank"
